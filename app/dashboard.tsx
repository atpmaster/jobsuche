...
export function Dashboard({ applications, tasks, today }: DashboardProps) {
  ...
  const printReport = async () => {
    ...
    try {
      ...
      const rows = [...applications].sort((a, b) => (a.appliedOn || "9999").localeCompare(b.appliedOn || "9999")).map(item => ({
